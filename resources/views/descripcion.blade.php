@switch(Request::path())
    @case("/")
        ...
        @break
    @case("contacto")
        <meta name="description" content="¿Listo para impulsar tu negocio? Agenda una llamada o cotiza gratis con MaykCoffe. Expertos en desarrollo web, SEO y marketing digital para empresas en México." />
        <meta name="keywords" content="En MaykCoffe, agencia digital, en CDMX, especializada en desarrollo web, especializada en SEO, especializada en marketing digital, para empresas en México, Creamos páginas web rápidas, Creamos páginas web optimizadas para Google, estrategias personalizadas, para tu negocio, aparezca primero en buscadores, aumente sus ventas." />
        <meta property="og:title" content="Cotiza tu proyecto web con MaykCoffe | Desarrollo Web y SEO CDMX" />
        ...
        @break
    @case("portafolio")
        <meta name="description" content="Explora casos de éxito en desarrollo web, diseño visual, UX y posicionamiento SEO. Resultados reales con sitios rápidos, efectivos y listos para convertir." />
        <meta name="keywords" content="portafolio de desarrollo web, sitios web profesionales México, diseño web optimizado, casos de éxito SEO, proyectos realizados" />
        <meta property="og:title" content="Proyectos de Diseño Web que Generan Resultados" />
    ...
    @case("servicios/creacion-de-sitios-web")
        ...
        @break
    @case("servicios/consultoria-seo-tecnica-estrategica")
        <meta name="description" content="Eleva tu sitio web con una consultoría SEO completa. Auditamos, optimizamos y diseñamos estrategias que generan tráfico y ventas. ¡Empieza hoy!" />
        <meta name="keywords" content="consultoría SEO, SEO técnico, estrategia SEO, mejorar posicionamiento web, optimización SEO profesional" />
        <meta property="og:title" content="Consultoría SEO Técnica y Estratégica | Mejora tu posicionamiento en Google" />
